          ...
          <div className="w-full lg:w-3/5 text-center lg:text-left">
            ...
            >
              ...
              <a
                ...
                id="hero-cta-resume"
                className="group px-6 py-3.5 bg-gray-900/90 hover:bg-gray-800 border border-purple-500/50 hover:border-purple-400 rounded-full flex items-center gap-2 text-sm font-semibold text-purple-200 hover:text-white transition-all duration-300 hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] backdrop-blur-sm hover:-translate-y-0.5"
              >
                <svg
                  width="17"
                  height="17"
